...
__export(index_exports, {
  ...
  ZOOM_IN_LEAD_MS: () => ZOOM_IN_LEAD_MS,
  ZOOM_IN_SCALE: () => ZOOM_IN_SCALE,
  ZOOM_OUT_LAG_MS: () => ZOOM_OUT_LAG_MS,
  ZOOM_OUT_SCALE: () => ZOOM_OUT_SCALE,
  clampClipsToSource: () => clampClipsToSource,
  clipOutputFrames: () => clipOutputFrames,
  clipSpeed: () => clipSpeed,
  footageSegmentsAfter: () => footageSegmentsAfter,
  layoutClips: () => layoutClips,
  mergeContinuousClips: () => mergeContinuousClips,
  momentsToClips: () => momentsToClips,
  momentsToKeyframes: () => momentsToKeyframes,
